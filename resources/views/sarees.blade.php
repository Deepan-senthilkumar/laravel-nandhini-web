                ...
                <section class="product-listing">
                    ...
                    <div class="product-grid-main">
                        <article class="product-card-v2">
                            ...
                            <a href="{{ url('sarees') }}" style="text-decoration: none; color: inherit;">
                                ...
                                <div class="product-info-v2">
                                    ...
                                    <span class="product-category-v2">Premium Collection</span>
                                    <h3 class="product-name-v2">Exquisite Silk Saree</h3>
                                    <p class="product-desc-v2">A masterfully handwoven silk saree featuring intricate patterns and premium texture.</p>
                                    <p class="product-price-v2">
                                        ₹4,999
                                        <span class="product-price-old">₹6,499</span>
                                    </p>
                                </div>
                            </a>
                            <a href="{{ url('sarees') }}" class="add-to-cart-v2" style="text-decoration: none; display: block; text-align: center;">View Details</a>
                        </article>
                        @if ($products->count() > 0)
