...
@section('title', 'Kids Collection - Nandhini Silks')
                ...
                <section class="product-listing">
                    ...
                    <div class="product-listing-header">
                        <div class="header-left">
                            <span class="result-count">Showing 1-12 of 65 products</span>
                        </div>
                    ...
                    <div class="product-grid-main">
                        ...
                        <article class="product-card-v2">
                            ...
                            <a href="{{ url('product-detail') }}" style="text-decoration: none; color: inherit;">
                                <div class="product-image-v2">
                                    <img src="{{ asset('images/kids_pattu_pavadai_pink_gold_1773214272993.png') }}"
                                        alt="Pattu Pavadai">
                                </div>
                                <div class="product-info-v2">
                                    <div class="product-rating-v2">★★★★★</div>
                                    <span class="product-category-v2">Pattu Pavadai</span>
                                    <h3 class="product-name-v2">Traditional Pink Pattu Pavadai</h3>
                                    <p class="product-desc-v2">Exquisite pink silk lehenga set for girls with traditional
                                        golden motifs and a soft cotton lining for comfort.</p>
                                    <p class="product-price-v2">₹2,490</p>
                                </div>
                            </a>
                        ...
                        <article class="product-card-v2">
                            ...
                            <a href="{{ url('product-detail') }}" style="text-decoration: none; color: inherit;">
                                <div class="product-image-v2">
                                    <img src="{{ asset('images/kids_boys_silk_dhoti_set_cream_1773214287724.png') }}"
                                        alt="Kids Silk Set">
                                </div>
                                <div class="product-info-v2">
                                    <div class="product-rating-v2">★★★★☆</div>
                                    <span class="product-category-v2">Boys Wear</span>
                                    <h3 class="product-name-v2">Boys Silk Dhoti Set</h3>
                                    <p class="product-desc-v2">Adorable silk dhoti and shirt set for boys, perfect for baby
                                        naming ceremonies and festive occasions.</p>
                                    <p class="product-price-v2">₹1,290</p>
                                </div>
                            </a>
                            <button class="add-to-cart-v2">Add to Cart</button>
                        </article>
